editです
                    ...
                    <br>
                    性別
                    <input type="radio" name="gender" value="0" @if($contact->gender === 0 ) cheched @endif>男性
                    <input type="radio" name="gender" value="1" @if($contact->gender === 1 ) cheched @endif>女性
                    <br>
                    年齢
                    <select name="age">
                    ...
                    <option value="6" @if($contact->age === 6 ) selected @endif>60歳～歳</option>
                    </select>
                    <br>
                    お問い合わせ内容
